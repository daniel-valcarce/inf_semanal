    ...
    public partial class Administrador : Form
    {
        ...
        private void btn_act_infor_cons_Click(object sender, EventArgs e)
        {
            ...
            if (respuesta_insert == 1)
            {
                ...
                string URL = @"\" + url_archivo + "";

                Microsoft.Office.Interop.Excel.Application app = new Microsoft.Office.Interop.Excel.Application();
                Microsoft.Office.Interop.Excel.Workbook documentoexcel = app.Workbooks.Open(@"\" + url_archivo + "");
                try
                {

                    Microsoft.Office.Interop.Excel.Worksheet hojaexcel;
                    hojaexcel = (Microsoft.Office.Interop.Excel.Worksheet)documentoexcel.Worksheets[hoja];

                    if (Convert.ToInt32(cmb_asesor.SelectedValue)== 7)
                    {
                        hojaexcel.Cells[9, 7] = Convert.ToDecimal(txt_cemen_boqui.Text);
                        hojaexcel.Cells[10, 7] = Convert.ToDecimal(txt_cenefa.Text);
                        hojaexcel.Cells[11, 7] = Convert.ToDecimal(txt_ceramica.Text);
                        hojaexcel.Cells[12, 7] = Convert.ToDecimal(txt_gabine.Text);
                        hojaexcel.Cells[13, 7] = Convert.ToDecimal(txt_gres.Text);
                        hojaexcel.Cells[14, 7] = Convert.ToDecimal(txt_griferia.Text);
                        hojaexcel.Cells[15, 7] = Convert.ToDecimal(txt_lavaplatos.Text);
                        hojaexcel.Cells[16, 7] = Convert.ToDecimal(txt_pegos.Text);
                        hojaexcel.Cells[17, 7] = Convert.ToDecimal(txt_perfiles.Text);
                        hojaexcel.Cells[18, 7] = Convert.ToDecimal(txt_pintura.Text);
                        hojaexcel.Cells[19, 7] = Convert.ToDecimal(txt_porcela.Text);
                        hojaexcel.Cells[20, 7] = Convert.ToDecimal(txt_prod_quim.Text);
                        hojaexcel.Cells[21, 7] = Convert.ToDecimal(txt_sanitario.Text);
                        hojaexcel.Cells[22, 7] = Convert.ToDecimal(txt_tapetes.Text);
                        hojaexcel.Cells[23, 7] = Convert.ToDecimal(txt_lijas.Text);
                        hojaexcel.Cells[24, 7] = Convert.ToDecimal(txt_brochas.Text);
                        hojaexcel.Cells[25, 7] = Convert.ToDecimal(txt_adhesivos.Text);
                        hojaexcel.Cells[26, 7] = Convert.ToDecimal(txt_tuberia.Text);
                        hojaexcel.Cells[27, 7] = Convert.ToDecimal(txt_electrico.Text);
                        hojaexcel.Cells[28, 7] = Convert.ToDecimal(txt_cocinas.Text);
                        hojaexcel.Cells[29, 7] = Convert.ToDecimal(txt_incrus.Text);
                        hojaexcel.Cells[38, 15] = Convert.ToDecimal(txt_ventas_semanal.Text);

                    }
                    if (Convert.ToInt32(cmb_asesor.SelectedValue) == 6)
                    {

                        hojaexcel.Cells[9, 5] = Convert.ToDecimal(txt_cemen_boqui.Text);
                        hojaexcel.Cells[10, 5] = Convert.ToDecimal(txt_cenefa.Text);
                        hojaexcel.Cells[11, 5] = Convert.ToDecimal(txt_ceramica.Text);
                        hojaexcel.Cells[12, 5] = Convert.ToDecimal(txt_gabine.Text);
                        hojaexcel.Cells[13, 5] = Convert.ToDecimal(txt_gres.Text);
                        hojaexcel.Cells[14, 5] = Convert.ToDecimal(txt_griferia.Text);
                        hojaexcel.Cells[15, 5] = Convert.ToDecimal(txt_lavaplatos.Text);
                        hojaexcel.Cells[16, 5] = Convert.ToDecimal(txt_pegos.Text);
                        hojaexcel.Cells[17, 5] = Convert.ToDecimal(txt_perfiles.Text);
                        hojaexcel.Cells[18, 5] = Convert.ToDecimal(txt_pintura.Text);
                        hojaexcel.Cells[19, 5] = Convert.ToDecimal(txt_porcela.Text);
                        hojaexcel.Cells[20, 5] = Convert.ToDecimal(txt_prod_quim.Text);
                        hojaexcel.Cells[21, 5] = Convert.ToDecimal(txt_sanitario.Text);
                        hojaexcel.Cells[22, 5] = Convert.ToDecimal(txt_tapetes.Text);
                        hojaexcel.Cells[23, 5] = Convert.ToDecimal(txt_lijas.Text);
                        hojaexcel.Cells[24, 5] = Convert.ToDecimal(txt_brochas.Text);
                        hojaexcel.Cells[25, 5] = Convert.ToDecimal(txt_adhesivos.Text);
                        hojaexcel.Cells[26, 5] = Convert.ToDecimal(txt_tuberia.Text);
                        hojaexcel.Cells[27, 5] = Convert.ToDecimal(txt_electrico.Text);
                        hojaexcel.Cells[28, 5] = Convert.ToDecimal(txt_cocinas.Text);
                        hojaexcel.Cells[29, 5] = Convert.ToDecimal(txt_incrus.Text);
                        hojaexcel.Cells[37, 15] = Convert.ToDecimal(txt_ventas_semanal.Text);
                    } if (Convert.ToInt32(cmb_asesor.SelectedValue) == 9)
                    {
                        hojaexcel.Cells[36, 5] = Convert.ToDecimal(txt_cemen_boqui.Text);
                        hojaexcel.Cells[37, 5] = Convert.ToDecimal(txt_cenefa.Text);
                        hojaexcel.Cells[38, 5] = Convert.ToDecimal(txt_ceramica.Text);
                        hojaexcel.Cells[39, 5] = Convert.ToDecimal(txt_griferia.Text);
                        hojaexcel.Cells[40, 5] = Convert.ToDecimal(txt_lavaplatos.Text);
                        hojaexcel.Cells[41, 5] = Convert.ToDecimal(txt_pegos.Text);
                        hojaexcel.Cells[42, 5] = Convert.ToDecimal(txt_pintura.Text);
                        hojaexcel.Cells[43, 5] = Convert.ToDecimal(txt_porcela.Text);
                        hojaexcel.Cells[44, 5] = Convert.ToDecimal(txt_sanitario.Text);
                        hojaexcel.Cells[45, 5] = Convert.ToDecimal(txt_lijas.Text);
                        hojaexcel.Cells[46, 5] = Convert.ToDecimal(txt_brochas.Text);
                        hojaexcel.Cells[47, 5] = Convert.ToDecimal(txt_tuberia.Text);
                        hojaexcel.Cells[48, 5] = Convert.ToDecimal(txt_incrus.Text);
                        hojaexcel.Cells[40, 15] = Convert.ToDecimal(txt_ventas_semanal.Text);
                    }
                    if (Convert.ToInt32(cmb_asesor.SelectedValue) == 8)
                    {
                        hojaexcel.Cells[9, 11] = Convert.ToDecimal(txt_cemen_boqui.Text);
                        hojaexcel.Cells[10, 11] = Convert.ToDecimal(txt_cenefa.Text);
                        hojaexcel.Cells[11, 11] = Convert.ToDecimal(txt_ceramica.Text);
                        hojaexcel.Cells[12, 11] = Convert.ToDecimal(txt_gabine.Text);
                        hojaexcel.Cells[13, 11] = Convert.ToDecimal(txt_gres.Text);
                        hojaexcel.Cells[14, 11] = Convert.ToDecimal(txt_griferia.Text);
                        hojaexcel.Cells[15, 11] = Convert.ToDecimal(txt_lavaplatos.Text);
                        hojaexcel.Cells[16, 11] = Convert.ToDecimal(txt_pegos.Text);
                        hojaexcel.Cells[17, 11] = Convert.ToDecimal(txt_perfiles.Text);
                        hojaexcel.Cells[18, 11] = Convert.ToDecimal(txt_pintura.Text);
                        hojaexcel.Cells[19, 11] = Convert.ToDecimal(txt_porcela.Text);
                        hojaexcel.Cells[20, 11] = Convert.ToDecimal(txt_prod_quim.Text);
                        hojaexcel.Cells[21, 11] = Convert.ToDecimal(txt_sanitario.Text);
                        hojaexcel.Cells[22, 11] = Convert.ToDecimal(txt_tapetes.Text);
                        hojaexcel.Cells[23, 11] = Convert.ToDecimal(txt_lijas.Text);
                        hojaexcel.Cells[24, 11] = Convert.ToDecimal(txt_brochas.Text);
                        hojaexcel.Cells[25, 11] = Convert.ToDecimal(txt_adhesivos.Text);
                        hojaexcel.Cells[26, 11] = Convert.ToDecimal(txt_tuberia.Text);
                        hojaexcel.Cells[27, 11] = Convert.ToDecimal(txt_electrico.Text);
                        hojaexcel.Cells[29, 11] = Convert.ToDecimal(txt_cocinas.Text);
                        hojaexcel.Cells[28, 11] = Convert.ToDecimal(txt_incrus.Text);
                        hojaexcel.Cells[39, 15] = Convert.ToDecimal(txt_ventas_semanal.Text);
                    }
                ...
                catch (Exception ex)
                {
                    ...
                    documentoexcel = null;
                    app = null;
                    MessageBox.Show("Error al realizar el formato talvez este abierto en otro computador" + ex.Message);
                    return;
                }
        ...
        private void btn_listo_Click(object sender, EventArgs e)
        {
            ...
            if (url_archivo == null)
            {
                MessageBox.Show("Seleccione el Archivo del Informe");
                return;
            }
            double[] valores_informe = tomar_valores();
